<?php session_start(); if(isset($_SESSION['id_control'])){ header('location:main'); }?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="prosescon/hancon?thisposition=<?php echo base64_encode('logincon'); ?>" method="post">
